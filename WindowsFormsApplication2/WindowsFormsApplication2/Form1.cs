...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                string myConnection = @"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Sima\Desktop\Proiect II\Proiect_II\Proiect_II\Database1.mdf;Integrated Security=True;User Instance=True";
